<section id="problem" className="py-24 gradient text-stone-950">
  <div className="container mx-auto px-6 max-w-5xl text-center">
    ...
    <div className="mt-12 grid md:grid-cols-3 gap-8 text-left">
      ...
      <div>
        <h3 className="font-semibold text-xl mb-2">❌ Manual Orders</h3>
      ...
      <div>
        <h3 className="font-semibold text-xl mb-2">❌ Poor Product Cataloging</h3>
        <p className="text-stone-600">
      ...
      <div>
        <h3 className="font-semibold text-xl mb-2">❌ Outdated Websites</h3>
        <p className="text-stone-600">
